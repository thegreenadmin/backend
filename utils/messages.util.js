module.exports = {
    ...
    USER_FAVOURITE_STORE_ADDED_SUCCESSFULLY: "Store added to favorites successfully",
    USER_NOT_VERIFIED: "User is not verified",

    STORE_CREATED_SUCCESSFULLY: "Store created successfully",
    STORE_UNAVAILABLE: "Store is unavailable",
    STORE_NOT_ENABLED: "Store not enabled, Please contact store owner to enabled the store.",

    FAVOURITE_STORE_ALREADY_EXISTS: "Store already added to favorites",
    FAVOURITE_STORE_NOT_EXISTS: "Favourite store not exists",
    FAVOURITE_STORE_REMOVED_SUCCESSFULLY: "Store removed from favorites successfully",
    ...
    CONTROLLER_BELONGS_ONLY_TO_STORE_OWNER: "Controller only belongs to store owner",
    CONTROLLERS_SUCCESSFULLY_FETCHED: "Controllers successfully fetched",


    INVALID_STORE_USER_CREATING_CONSTRAINTS: "Store user could not create as some constraints are missing",
    ...
    STORE_ROLE_PERMISSIONS_SUCCESSFULLY_FETCHED: "Store role permissions successfully fetched",
