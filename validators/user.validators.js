...
const { JOI_FIRST_NAME, JOI_LAST_NAME, JOI_EMAIL, JOI_PHONE, JOI_DOB, JOI_HANDLE_BODY_VALIDATION, JOI_OTP, JOI_DEVICE_ID, JOI_DEVICE_TOKEN, JOI_IMAGE, JOI_NUMBER, JOI_STRING, JOI_DATE, JOI_BOOLEAN } = require('../utils/joi.utils');
...
const createUserProofValidator = function(req, res, next) {
    const schema = Joi.object({
        ...
        expiredAt: (req.body.expiredAt != "") ? JOI_DATE.label("Expiary Date").required() : ''
    });
    JOI_HANDLE_BODY_VALIDATION(schema, req, res, next);
}
...
module.exports = {
    userCreateValidator, generateOTPValidator, verifyOTPValidator,
    createUserProofValidator, createFavouriteStoreValidator, removeFavouriteStoreValidator,
